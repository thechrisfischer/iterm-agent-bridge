...
ADAPTERS = {
    ...
    "kimi": ("kimi", {"TurnStarted": "turn_started", "PreToolUse": "tool_started", "PostToolUse": "tool_finished", "PermissionRequest": "permission_requested", "PermissionResult": "permission_resolved", "Stop": "turn_finished", "SubagentStart": "child_started", "SubagentStop": "child_finished", "SessionEnd": "session_closed"}),
